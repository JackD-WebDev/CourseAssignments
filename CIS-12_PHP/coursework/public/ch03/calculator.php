...
/*
1. In the previous version of this file values selected were reset upon submission, whereas entered values are retained in this version.
2. In the third version of this file the fuel cost radio buttons were generated programmatically via function.
3. The fourth version of this file contains a function that allows the type of radio button to be determined with a second argument.
4. The fifth iteration of the file implements a function to return the value of the trip cost as a variable.
5. Finally, the program has been updated to prevent the accidental input of negative numbers.
*/
