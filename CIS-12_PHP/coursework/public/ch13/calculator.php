...
<form action="calculator.php" method="post">
    <p><label>Quantity: <input type="number" name="quantity" step="1" min="1" value="<?php if  (isset($quantity)) echo $quantity; ?>"></label></p>
    <p><label>Price: <input type="number" name="price" step=".01" min="0.01" value="<?php if  (isset($price)) echo $price; ?>"></label></p>
    <p><label>Tax (%): <input type="text" name="tax" step=".01" min="0.01" value="<?php if  (isset($tax)) echo $tax; ?>"></label></p>
